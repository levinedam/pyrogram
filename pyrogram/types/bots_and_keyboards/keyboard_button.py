...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_managed_bot (:obj:`~pyrogram.types.KeyboardButtonRequestManagedBot`, *optional*):
            If specified, pressing the button will ask the user to create and share a bot managed by current bot.
    ...
    def write(self):
        ...
        if self.request_contact:
            return self._construct_raw(
                raw.types.KeyboardButtonRequestPhone,
                text=self.text,
                style=style
            )
        elif self.request_location:
            return self._construct_raw(
                raw.types.KeyboardButtonRequestGeoLocation,
                text=self.text,
                style=style
            )
        elif self.request_poll:
            return self._construct_raw(
                raw.types.KeyboardButtonRequestPoll,
                text=self.text,
            ...
            return self._construct_raw(
                raw.types.KeyboardButtonSimpleWebView,
                text=self.text,
